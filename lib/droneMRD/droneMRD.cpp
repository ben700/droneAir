...
IPAddress stationIP = IPAddress(4, 20, 4, 20);
IPAddress gatewayIP = IPAddress(4, 29, 4, 20);
...
#ifdef ESP32
IPAddress stationIP = IPAddress(4, 20, 4, 32);
#else
IPAddress stationIP = IPAddress(4, 20, 4, 20);
#endif

IPAddress gatewayIP = IPAddress(4, 20, 4, 20);
IPAddress netMask = IPAddress(255, 255, 255, 0);
#endif
...
IPAddress APStaticIP = IPAddress(4, 20, 4, 20);
IPAddress APStaticGW = IPAddress(4, 20, 4, 20);
